...
import sys
sys.path.append(r"/home/transfusion-asr/transfusion")
import deepspeed
import numpy as np
import pandas as pd
import torch
...
from transfusion.count_para import count_parameters
...
class TrainConfig:
    ...
    max_steps: int = 999_000_000 # 500_000 #1_000_000
    ...
    resume_checkpoint: str = 'ckpt_01250000'
...
def train(rank, cfg: TrainConfig, deepspeed_cfg: argparse.Namespace):
    ...
    # ckpt = torch.load("/home/transfusion-asr/runs/full_finetune2/462k/mp_rank_00_model_states.pt", map_location=device)
    # print("好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好好")
    # print(ckpt['module'].items())
    # getout = ['char_embedding.weight', 'head.1.weight', 'head.1.bias']
    # pretrained_dict = {k: v for k, v in ckpt['module'].items() if k not in getout}
    ...
    if cfg.resume_checkpoint != '':
        _, client_sd = model_engine.load_checkpoint(cfg.checkpoint_path, tag=cfg.resume_checkpoint, load_module_strict = False)
